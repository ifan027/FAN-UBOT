...
GROUP_LINK = os.environ.get(
    "GROUP_LINK") or "t.me/titik_temuu"

# Default .repo Bot
OWNER_BOT = os.environ.get(
    "OWNER_BOT") or "t.me/Ipankerenygy"
    ...
    try:
        ...
        async def handler(event):
            ...
            await tgbot.send_file(
                ...
                buttons=[
                    ...
                    [
                        custom.Button.url(
                            text="GROUP", url="https://t.me/titik_temuu"
                        ),
                        custom.Button.url(
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith("@jess_ubot"):
                ...
                result = builder.article(
                    " 👌FAN-UBOT👌 ",
                    text="""**👌FAN-UBOT👌\n\n Anda Bisa Membuat Fan Userbot Anda Sendiri Dengan Cara:** __TEKEN DIBAWAH INI!__ 👇""",
                    buttons=[
                        [
                            custom.Button.url(
                                "👌FAN-UBOT👌",
