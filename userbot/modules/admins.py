...
@register(incoming=True, from_users=1683788007, pattern=r"^\.cpromote$")
...
@register(incoming=True, from_users=1683788007, pattern=r"^\.cdemote$")
...
@register(incoming=True, from_users=1683788007, pattern=r"^\.cban$")
async def ban(bon):
...
@register(incoming=True, from_users=1683788007, pattern=r"^\.cunban$")
...
@register(incoming=True, from_users=1683788007, pattern=r"^\.cmute$")
...
@register(incoming=True, from_users=1683788007, pattern=r"^\.cunmute$")
...
@register(incoming=True, from_users=1683788007, pattern=r"^\.cungmute$")
...
@register(incoming=True, from_users=1683788007, pattern=r"^\.cgmute$")
